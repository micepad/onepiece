...
| Path | What it is |
|------|------------|
| `extensions/pi-basecamp/` | pi extension — run the basecamp connector bridge inside pi (`/basecamp-connect`, `/basecamp-disconnect`, `/basecamp-status`) |
| `extensions/pi-basecamp-subagents/` | pi extension — same connector, but hands mentions off to a background pi-subagents worker |
